...
reviewSchema.index({ tour: 1, user: 1 }, { unique: true }); //prevents duplicate reviews

reviewSchema.pre(/^find/, function(next) {
  //Below will increase query time
  // this.populate({
  //   path: 'tour',
  //   select: 'name'
  // }).populate({
...
//Below this, the nRating avgRating isn't working!
reviewSchema.statics.calcAverageRatings = async function(tourId) {
  //'this' now points to the current model
